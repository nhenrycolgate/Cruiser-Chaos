function Cruiser(engine, render, transform, speed, direction, hp, enemyType) {
...
function CruiserRender() {
    ...
    var bodyMaterial = new THREE.MeshLambertMaterial({color:Colors.red, shading:THREE.FlatShading});
    ...
    var windowMaterial = new THREE.MeshLambertMaterial({color:Colors.white, shading:THREE.FlatShading});
